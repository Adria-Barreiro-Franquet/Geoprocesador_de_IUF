...
Plugin de QGIS para el mapeo y análisis de la Interfaz Urbano-Forestal de una region determinada.  
Integra múltiples metodologías científicas para la gestión del riesgo de incendios.

---

## DESCRIPCIÓN
Este plugin permite automatizar el cálculo de las zonas de IUF cruzando geodatos de edificaciones (de cualquier origen) con la capa de usos del suelo del SIOSE AR.  
...
## INSTALACIÓN DESDE GITHUB (WINDOWS)
...
3.  Entrar en la carpeta del plugin y ejecutar `...\plugins\Geoprocesador_de_IUF\fragstats\fragstats version 4.2.681[x64] INSTALLER.exe`, esto instalará software indispensable para ejecutar el plugin, dejar todo por defecto.
